    ...
    <div className="max-w-6xl mx-auto p-6 md:p-12 animate-fadeIn">
      <div className="flex flex-col md:flex-row justify-between items-start mb-10">
        <div className="mb-4 md:mb-0">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            {isAgency ? (
              <div className="bg-gradient-to-r from-amber-500/20 to-indigo-500/20 border border-amber-500/40 text-amber-400 text-xs font-bold px-2.5 py-1 rounded-full flex items-center gap-1">
                <Crown size={12} /> AGENCY OWNER
              </div>
            ) : (
              <div className={`text-xs font-bold px-2.5 py-1 rounded-full flex items-center gap-1 border ${isLimitReached ? 'bg-indigo-500/10 text-indigo-400 border-indigo-500/20' : 'bg-slate-700 text-slate-300 border-slate-600'}`}>
      ...
      {!loadingProjects && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {projects.length === 0 && (
            <div className="col-span-full flex flex-col items-center justify-center py-20 bg-slate-900/30 border border-dashed border-slate-700 rounded-2xl">
